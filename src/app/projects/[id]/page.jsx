      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200 p-8 mb-8">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-lg">by {project.owner?.login}</p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center p-4 bg-gradient-to-br from-yellow-50 to-orange-50 rounded-xl border border-yellow-200">
              ...
              <div className="text-2xl font-bold text-gray-800">{formatNumber(project.stargazers_count)}</div>
              <div className="text-sm text-gray-600">Stars</div>
            </div>
            <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl border border-blue-200">
              <div className="text-blue-600 text-2xl mb-2">🍴</div>
              <div className="text-2xl font-bold text-gray-800">{formatNumber(project.forks_count)}</div>
              <div className="text-sm text-gray-600">Forks</div>
            </div>
            <div className="text-center p-4 bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl border border-green-200">
              <div className="text-green-600 text-2xl mb-2">👀</div>
              <div className="text-2xl font-bold text-gray-800">{formatNumber(project.watchers_count)}</div>
            ...
            <div className="text-center p-4 bg-gradient-to-br from-red-50 to-pink-50 rounded-xl border border-red-200">
              ...
              <div className="text-2xl font-bold text-gray-800">{project.open_issues_count}</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                    ...
                    />
                    <span className="font-medium text-gray-800">{project.owner?.login}</span>
                  </div>
                </div>
                <div>
                  <label className="text-sm font-semibold text-gray-600 mb-1 block">Primary Language</label>
                ...
                <div>
                  <label className="text-sm font-semibold text-gray-600 mb-1 block">Repository Size</label>
                  <div className="p-3 bg-gray-50 rounded-lg">
                    <span className="font-medium text-gray-800">{(project.size / 1024).toFixed(2)} MB</span>
                  </div>
                </div>
                <div>
                  <label className="text-sm font-semibold text-gray-600 mb-1 block">Default Branch</label>
                  <div className="p-3 bg-gray-50 rounded-lg">
                    <span className="font-medium text-gray-800">{project.default_branch}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {project.license && (
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200 p-6">
                ...
                <div className="p-4 bg-green-50 rounded-xl border border-green-200">
                  <h3 className="font-bold text-green-800 text-lg mb-2">{project.license.name}</h3>
                  <p className="text-green-700 text-sm">SPDX ID: {project.license.spdx_id}</p>
                </div>
              </div>
            )}
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200 p-6">
              ...
              <div className="space-y-4">
                ...
                {project.homepage && (
                  ...
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9v-9m0-9v9m0 9c-5 0-9-4-9-9m9 9c5 0 9-4 9-9m-9 9c0-5 4-9 9-9m-9 9c0 5-4 9 9-9" />
                    </svg>
                    Visit Website
                  </a>
                )}
                <button
                  onClick={() => navigator.clipboard.writeText(project.clone_url)}
            ...
            {/* Metadata */}
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200 p-6">
              <h2 className="text-xl font-bold text-gray-800 mb-6">Repository Details</h2>
              <div className="space-y-4">
                ...
                <div className="flex justify-between py-2 border-b border-gray-100">
                  ...
                  <span className="font-medium text-gray-800">{formatDate(project.updated_at)}</span>
                </div>
                <div className="flex justify-between py-2 border-b border-gray-100">
                  <span className="text-gray-600">Pushed</span>
                  <span className="font-medium text-gray-800">{formatDate(project.pushed_at)}</span>
                </div>
                <div className="flex justify-between py-2 border-b border-gray-100">
