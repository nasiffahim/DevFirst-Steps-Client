...
import { Github, Star, GitFork, Code, Calendar, ExternalLink, AlertCircle, Loader2 } from "lucide-react";
...
export default function PythonProjectsPage() {
  ...
  const category = "python-projects";
  ...
  useEffect(() => {
    const fetchProjects = async () => {
      ...
      try {
        // Axios automatically handles response status and throws errors for bad responses
        ...
        setError(err.response?.data?.error || "Failed to fetch projects. Please try again later.");
      } finally {
        setLoading(false);
      }
    };
    ...
    return (
      <div className="min-h-screen bg-white dark:bg-gradient-to-br dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center p-6">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-gray-600 dark:text-gray-300 text-lg">Loading Python Projects...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-white dark:bg-gradient-to-br dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center p-6">
        <div className="bg-red-50 dark:bg-red-900/20 border border-red-300 dark:border-red-500/50 rounded-xl p-6 max-w-md">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="text-xl font-semibold text-red-800 dark:text-red-300">Error</h3>
          </div>
          ...
          <div className="flex items-center gap-4 mb-3">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 mt-1">
                Explore amazing Python repositories
              </p>
            </div>
          </div>
          <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
            <Github className="w-4 h-4" />
            <span>{projects.length} {projects.length === 1 ? 'repository' : 'repositories'} found</span>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {projects.length === 0 ? (
          <div className="text-center py-12">
            <Github className="w-16 h-16 text-gray-300 dark:text-gray-600 mx-auto mb-4" />
            ...
            {projects.map((project) => (
              ...
              >
                ...
                <div className="flex items-start justify-between mb-3">
                  ...
                  <Github className="w-5 h-5 text-gray-400 dark:text-gray-500 flex-shrink-0 ml-2" />
                </div>
