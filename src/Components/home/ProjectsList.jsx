      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          {projects.map((repo, index) => (
            <div
              key={repo.id}
              className="p-5 border-2 border-gray-200 rounded-lg hover:shadow-lg transition-all duration-300 bg-white/80 backdrop-blur-sm group transform hover:scale-105 flex flex-col animate-fade-in-up"
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-gray-100 hover:bg-gradient-to-r hover:from-blue-600 hover:to-purple-600 text-gray-700 hover:text-white rounded-lg transition-all duration-300 text-sm font-medium border border-gray-200 hover:border-transparent"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center px-3 py-2 bg-gray-800 hover:bg-gray-900 text-white rounded-lg font-medium transition-all duration-200 text-sm"
