      ...
      <div className="border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex items-center gap-4 mb-3">
            <div className="p-3 bg-green-100 dark:bg-green-400/10 rounded-xl">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 mt-1">
                Discover powerful DevOps and automation tools
              </p>
            </div>
          </div>
        ...
        {projects.length === 0 ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {projects.map((project) => (
              <div
                key={project.id}
                className="group bg-gray-50 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-xl border border-gray-200 dark:border-gray-700/50 hover:border-green-400 dark:hover:border-green-500/50 transition-all duration-300 hover:scale-[1.02] flex flex-col"
              >
                {/* Project Header */}
                <div className="flex items-start justify-between mb-3">
                  <div className="flex-1">
                    <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-1 line-clamp-1 group-hover:text-green-600 dark:group-hover:text-green-400 transition-colors">
                      {project.name}
                    </h2>
                  ...
                  <Server className="w-5 h-5 text-gray-400 dark:text-gray-500 flex-shrink-0 ml-2" />
                </div>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-200 dark:border-gray-700/50">
                  ...
                  <a
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-green-100 dark:bg-green-400/10 hover:bg-green-200 dark:hover:bg-green-400/20 text-green-700 dark:text-green-400 rounded-lg text-sm font-medium transition-all duration-200 hover:gap-3"
                  >
                    <span>View</span>
