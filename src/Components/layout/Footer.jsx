...
const Footer = () => {
  ...
  const resources = ["Documentation", "API Reference", "Tutorials", "Blog"];
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 dark:text-gray-300 text-sm leading-relaxed mb-6 transition-colors duration-300">
              Discover, contribute, and learn from the best open source
              projects. Connect with a community of passionate developers
              building the future.
            </p>
            ...
            <div className="flex gap-4">
              <a
                href="#"
                className="w-10 h-10 bg-gray-800 dark:bg-gray-700 hover:bg-blue-600 dark:hover:bg-blue-500 rounded-lg flex items-center justify-center transition-all duration-200 group"
              >
                <Github className="w-5 h-5 text-gray-400 dark:text-gray-300 group-hover:text-white" />
              </a>
              <a
                href="#"
                className="w-10 h-10 bg-gray-800 dark:bg-gray-700 hover:bg-blue-500 dark:hover:bg-blue-400 rounded-lg flex items-center justify-center transition-all duration-200 group"
              >
                <FaXTwitter className="w-5 h-5 text-gray-400 dark:text-gray-300 group-hover:text-white" />
              </a>
              <a
                href="#"
                className="w-10 h-10 bg-gray-800 dark:bg-gray-700 hover:bg-blue-700 dark:hover:bg-blue-600 rounded-lg flex items-center justify-center transition-all duration-200 group"
              >
                <Linkedin className="w-5 h-5 text-gray-400 dark:text-gray-300 group-hover:text-white" />
              </a>
              <a
                href="#"
                className="w-10 h-10 bg-gray-800 dark:bg-gray-700 hover:bg-red-600 dark:hover:bg-red-500 rounded-lg flex items-center justify-center transition-all duration-200 group"
              >
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-semibold mb-4 text-white dark:text-gray-100 transition-colors duration-300">
              Quick Links
            </h4>
            <ul className="space-y-3">
              {quickLinks.map((link, index) => (
                <li key={index}>
                  <a
                    href="#"
                    className="text-gray-400 dark:text-gray-300 hover:text-white dark:hover:text-gray-100 transition-colors duration-200 flex items-center gap-2 group"
                  >
                    <span>{link}</span>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 gap-2">
              {techStacks.map((stack, index) => (
                ...
                >
                  <span className="text-gray-400 dark:text-gray-300 text-sm transition-colors duration-300">
                    {stack.name}
                  </span>
                  <span className="text-xs bg-gray-800 dark:bg-gray-700 text-gray-300 dark:text-gray-200 px-2 py-1 rounded-full transition-colors duration-300">
                    {stack.count}
                  </span>
                </div>
              ))}
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 dark:border-gray-700 transition-colors duration-300">
          <div className="max-w-md mx-auto text-center">
            <h4 className="text-lg font-semibold mb-2 text-white dark:text-gray-100 transition-colors duration-300">
              Stay Updated
            </h4>
            <p className="text-gray-400 dark:text-gray-300 text-sm mb-4 transition-colors duration-300">
              Get notified about new projects and features
            </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div className="group">
              <div className="flex items-center justify-center gap-2 mb-2">
                ...
                <span className="text-2xl font-bold text-white dark:text-gray-100 transition-colors duration-300">
                  500+
                </span>
              </div>
